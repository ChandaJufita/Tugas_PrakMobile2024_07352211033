          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                ...
                Color.fromARGB(255, 152, 209, 255),
              ],
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const SizedBox(height: 10, ),
        ServiceCard(
          imageUrl: 'assets/images/jeni.jpg',
          name: 'Miss Jennie Kim',
          role: 'Artis',
  ...
  Widget build(BuildContext context) {
    return Column(
        children: [
          BestBookingCard(
            imageUrl: 'assets/images/kim.jpeg',
            profileUrl: 'assets/images/kim.jpeg',
          ...
          BestBookingCard(
            imageUrl: 'assets/images/jeni.jpg',
            profileUrl: 'assets/images/jeni.jpg',
            name: 'Miss Zachary Will',
            role: 'Beautician',
            description: 'Occaecati aut nam beatae quo non deserunt consequatur.',
            rating: 4.9,
          ...
          Stack(
            children: [
              ClipRRect(
                ...
                child: Image.asset(
                  'assets/images/mark.jpg', // Ganti dengan path gambar Anda
                  height: 230,
                  width: double.infinity,
                  fit: BoxFit.cover,
                ),
