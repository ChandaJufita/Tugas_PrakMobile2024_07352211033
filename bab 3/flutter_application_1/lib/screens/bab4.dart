...
class _Bab4State extends State<Bab4> {
  ...
  List<CartItem> cartItems = [
    CartItem(
        gambar: "assets/images/jeni.jpg",
        judul: "Tiket konser kim jennie",
        deskripsi: "dapatkan kesempatan bertemu sang idola",
        harga: 4,
        jumlah: 1),
    CartItem(
        gambar: "assets/images/kim.jpeg",
        judul: "Tiket konser kim younghoon",
        deskripsi: "dapatkan kesempatan bertemu sang idola",
        harga: 4,
        jumlah: 1),
    CartItem(
        gambar: "assets/images/mark.jpg",
        judul: "Tiket konser mark lee",
        deskripsi: "dapatkan kesempatan bertemu sang idola",
        harga: 4,
        jumlah: 1),
  ];
